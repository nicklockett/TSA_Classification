...
if __name__ == '__main__':
    ...
    dataset = dataCreator.CreateTensorFlowDataSetFromBlockStream(channels = 3, block_size = 48, resize = 224, augment = True, segmentNumber = 0.8, image_filepath = "../../../rec/data/PSRC/Data/stage1/a3d/", nii_filepath = "../visualize/data/Batch_2D_warp_labels/")

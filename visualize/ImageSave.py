...
class ImageSaver:
	...
	def load_images_from_folder(self, max_folder, sum_folder, var_folder, resize):
		...
		for index in range(0,num_images):
			...
			file_id, is_threat, region, x, y = max_image_filename.split("_")
			...
			data_channel_2 = scipy.misc.imresize(arr = var_array, size=(resize, resize))
			data_channel_3 = data_channel_1

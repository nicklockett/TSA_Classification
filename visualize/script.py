...
im.load_images_and_save_as_arrays(resize = 299, max_folder = "generated_blocks/block_size_58/max/", sum_folder = "generated_blocks/block_size_58/sum/", var_folder= "generated_blocks/block_size_58/var/")
